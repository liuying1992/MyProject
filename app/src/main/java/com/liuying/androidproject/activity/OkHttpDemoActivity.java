...
import com.liuying.okhttputils.callback.BitmapCallback;
import com.liuying.okhttputils.callback.FileCallBack;
import com.liuying.okhttputils.callback.GenericsCallback;
import com.liuying.okhttputils.callback.StringCallback;
import com.liuying.okhttputils.cookie.CookieJarImpl;
import java.io.File;
...
/**
 * Created by liuying on 2019/4/10 17:00.
 * Email: ly1203575492@163.com
 */
@Route(path = "/okhttp/demo") public class OkHttpDemoActivity extends BaseActivity {
  ...
  public class MyStringCallback extends StringCallback {
    @Override public void onBefore(Request request, int id) {
      setTitle("loading...");
    }

    @Override public void onAfter(int id) {
    ...
    @Override public void onResponse(String response, int id) {
      ...
      switch (id) {
        case 100:
          Toast.makeText(OkHttpDemoActivity.this, "http", Toast.LENGTH_SHORT).show();
          break;
        case 101:
          Toast.makeText(OkHttpDemoActivity.this, "https", Toast.LENGTH_SHORT).show();
          break;
      }
    }
  ...
  public void getUser(View view) {
    ...
    OkHttpUtils.post()//
        ...
        .execute(new GenericsCallback<User>(new JsonGenericsSerializator()) {
          ...
          @Override public void onResponse(User response, int id) {
  ...
  public void getUsers(View view) {
    ...
    OkHttpUtils//
        ...
        .execute(new ListUserCallback()//
        {
          ...
          @Override public void onResponse(List<User> response, int id) {
            mTv.setText("onResponse:" + response);
          }
        });
  }
  ...
  public void getImage(View view) {
    ...
    OkHttpUtils.get()//
      ...
      @Override public void onResponse(Bitmap bitmap, int id) {
        Log.e("TAG", "onResponse：complete");
  ...
  public void downloadFile(View view) {
    String url =
        "https://github.com/hongyangAndroid/okhttp-utils/blob/master/okhttputils-2_4_1.jar?raw=true";
    OkHttpUtils//
        .get()//
        .url(url)//
        .build()//
            ...
            "gson-2.2.1.jar")//
        {
          ...
          @Override public void onResponse(File file, int id) {
